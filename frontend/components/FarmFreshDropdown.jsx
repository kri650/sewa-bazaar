  ...
  return createPortal(
    <div className="farm-dropdown" style={{ display: isOpen ? 'block' : 'none', position: 'absolute', left: pos.left + 'px', top: pos.top + 'px', minWidth: pos.width + 'px' }}>
      <ul className="farm-dropdown-list">
        <li>
          <Link href="/farm-fresh-picks/vegetables" style={{ color: 'inherit', textDecoration: 'none', display: 'block' }}>
            Vegetables
          </Link>
        </li>
        <li>
          <Link href="/farm-fresh-picks/fruits" style={{ color: 'inherit', textDecoration: 'none', display: 'block' }}>
            Fruits
          </Link>
        </li>
      </ul>
