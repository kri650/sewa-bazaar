  ...
  return createPortal(
    <div className="veg-dropdown" style={{ display: isOpen ? 'block' : 'none', position: 'absolute', left: pos.left + 'px', top: pos.top + 'px', minWidth: pos.width + 'px' }}>
      <ul className="veg-dropdown-list">
        <li>
          <Link href="/vegetables/leafy-vegetables" style={{ color: 'inherit', textDecoration: 'none', display: 'block' }}>
            Leafy Vegetables
          </Link>
        </li>
        <li>
          <Link href="/vegetables/regular-vegetables" style={{ color: 'inherit', textDecoration: 'none', display: 'block' }}>
          Regular Vegetables
         </Link>
        </li>
        <li>
          <Link href="/vegetables/exotic-vegetables" style={{ color: 'inherit', textDecoration: 'none', display: 'block' }}>
        Exotic Vegetables
          </Link>
          </li>
        <li>
          <Link href="/vegetables/gourds-and-pumpkin" style={{ color: 'inherit', textDecoration: 'none', display: 'block' }}>
        Gourds & Pumpkin
          </Link>
          </li>
        <li>
          <Link href="/vegetables/salad-vegetables" style={{ color: 'inherit', textDecoration: 'none', display: 'block' }}>
        Salad Vegetables
          </Link>
          </li>
