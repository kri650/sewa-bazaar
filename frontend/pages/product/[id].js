...
const allProducts = [
  ...
  // Latest Arrivals (homepage feature dishes)
  { id: 'premium-basmati-rice', name: 'Premium Basmati Rice', price: 320.00, size: '1 KG', image: 'https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=1080/da/cms-assets/cms/product/c043d662-8d30-4bd7-84c4-b0567cf87230.png?bg_token=color.background.quaternary', category: 'Atta Rice & Grains', description: 'Long-grain premium basmati rice with a delightful aroma. Perfect for biryanis, pulaos, and everyday meals. Aged for superior taste and texture.' },
  { id: 'pure-cow-ghee', name: 'Pure Cow Ghee', price: 580.00, size: '500 ML', image: 'https://ueirorganic.com/cdn/shop/files/purecowghee.jpg?v=1689066451', category: 'Oil & Ghee', description: '100% pure cow ghee made using traditional bilona method. Rich in healthy fats and vitamins. Perfect for cooking, tempering, and spreading on rotis.' },
  { id: 'cream-biscuits', name: 'Cream Biscuits', price: 30.00, size: '200 GM', image: 'https://images.jdmagicbox.com/quickquotes/images_main/cream-bites-choco-vanilla-biscuits-10-inr-2018631004-azywd2bz.jpg', category: 'Chips & Biscuits', description: 'Delicious cream-filled biscuits with a crispy outer layer. A perfect snack for tea time and kids\' lunch boxes.' },
  { id: 'full-cream-milk', name: 'Full Cream Milk', price: 60.00, size: '1 LITRE', image: 'https://instamart-media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/NI_CATALOG/IMAGES/ciw/2025/12/17/8e79f3bf-df99-4922-9169-0c70d4e57b3b_BZG9BW3AI5_MN_16122025.png', category: 'Milk & Dairy', description: 'Fresh full cream milk, rich in calcium and protein. Sourced daily from verified farms. Perfect for drinking, making tea, curds, and desserts.' },
