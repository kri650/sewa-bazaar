...
router.use('/product-requests', checkWarehouseAdmin)
...
router.get('/product-requests',               ctrl.getProductRequests)
router.patch('/product-requests/:id/fulfilled', ctrl.markProductRequestFulfilled)
router.delete('/product-requests/:id',        ctrl.deleteProductRequest)
